...
public class PrivateActivityDoctorsDeaf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress = new ProgressDialog(PrivateActivityDoctorsDeaf.this);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("DeafConsultation");
...
//        mErrorTv.setVisibility(View.GONE);
        ...
        mDiscussionsRef = FirebaseDatabase.getInstance().getReference().child("ForumMessagesDeaf").child(getIntent().getStringExtra("starter"))
        ...
        mAuthListener = firebaseAuth -> {
            if (currentUid != null) {
                if (currentUid.equals("DVo9Gv0QKufvNsFTJv8Gm0Zis2w1")) {
...
//                        Toast.makeText(PrivateActivityDeaf.this, "Your welcome to the consultation room", Toast.LENGTH_SHORT).show();
        ...
        mimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PrivateActivityDoctorsDeaf.this, "Soon", Toast.LENGTH_SHORT).show();
//                chooseImage();
            }
        });
...
//        Toast.makeText(this, "" + string, Toast.LENGTH_SHORT).show();
        dbRefFirstTimeCheck.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mProgress.dismiss();
                    Toast.makeText(PrivateActivityDoctorsDeaf.this, "Contact not found", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        FirebaseDatabase.getInstance().getReference().child("ForumMessagesDeaf").child(currentUid).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
...
//
        ...
        loadData();
        adapter = new DiscussionMessagesAdapter(PrivateActivityDoctorsDeaf.this, discussionList);
