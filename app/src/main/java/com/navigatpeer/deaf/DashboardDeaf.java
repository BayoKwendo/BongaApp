...
public class DashboardDeaf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Context context = DashboardDeaf.this;
...
//            }
            ...
            protected void onBindViewHolder(@NonNull ForumsViewHolder holder, final int position, @NonNull Forums model) {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("DeafConsultation");
                                            ...
                                            databaseReference.push().setValue(topicMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Intent i = new Intent(DashboardDeaf.this, PrivateActivityDeaf.class);
                                                        ...
                                                        mProgress.dismiss();
                                                        Toast.makeText(DashboardDeaf.this, "Error! Please check your connection.", Toast.LENGTH_LONG).show();
                                                    }
                                                }
                                            });
                                        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            startActivity(new Intent(DashboardDeaf.this, about.class));
        }
        if (id == R.id.profile) {
