...
public class AdminLoginDeaf extends AppCompatActivity {
    ...
    private static final String TAG = AdminLoginDeaf.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_login_deaf);
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    mProgress.dismiss();
                    Toast.makeText(AdminLoginDeaf.this, "Failed to sign in. Please try again.", Toast.LENGTH_LONG).show();
    ...
    void admin(){
        ...
        if (currentUid.equals("0tai9MHr8rSdqUqJ3RSAK6YfCQr2")){
            ...
            Toast.makeText(AdminLoginDeaf.this, "Your Not an Admin. Try Again!!", Toast.LENGTH_SHORT).show();
        }
    }
