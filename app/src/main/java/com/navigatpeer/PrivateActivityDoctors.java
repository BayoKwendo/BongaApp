...
public class PrivateActivityDoctors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress = new ProgressDialog(PrivateActivityDoctors.this);
        ...
        mDiscussionsRef = FirebaseDatabase.getInstance().getReference().child("ForumMessages").child(getIntent().getStringExtra("starter"))
...
//                        Toast.makeText(PrivateActivityDeaf.this, "Your welcome to the consultation room", Toast.LENGTH_SHORT).show();
        ...
        mimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PrivateActivityDoctors.this, "Soon", Toast.LENGTH_SHORT).show();
//                chooseImage();
            }
        });
...
//        Toast.makeText(this, "" + string, Toast.LENGTH_SHORT).show();
        dbRefFirstTimeCheck.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mProgress.dismiss();
                    Toast.makeText(PrivateActivityDoctors.this, "Contact not found", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        loadData();
        adapter = new DiscussionMessagesAdapter(PrivateActivityDoctors.this, discussionList);
